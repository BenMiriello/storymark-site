    ...
    <section className="py-16 px-6">
      <div className="max-w-text mx-auto">
        ...
        <div className="space-y-6 text-gray-700">
          <div>
            <h3 className="font-semibold mb-3">In Development:</h3>
          ...
          <p className="text-sm pt-4 border-t">
            <span className="font-semibold">Available now:</span> Core parser, React package, basic templates.
            <br />
            <span className="font-semibold">Available soon:</span> Hosted template gallery, editor integrations.
          </p>
        </div>
      </div>
    </section>
